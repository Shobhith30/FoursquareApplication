...
class PlaceLocationAdapter(private val mCtx : Context) : PagingDataAdapter<DataPlace,PlaceLocationAdapter.PlaceViewHolder>(DIFF_CALLBACK) {

    private val favouriteViewModel = ViewModelProvider.AndroidViewModelFactory(mCtx.applicationContext as Application).create(
        FavouriteViewModel::class.java)
    private val sharedPreferences: SharedPreferences = mCtx.getSharedPreferences(
    ...
    inner class PlaceViewHolder(val placeBinding : ItemPlaceBinding) : RecyclerView.ViewHolder(placeBinding.root){
