...
class FavouriteDataAdapter(private val mCtx : Context) : PagingDataAdapter<Place, FavouriteDataAdapter.ItemViewHolder>(DIFF_CALLBACK) {
    private var listener : OnFavouriteCLickListener?=null
    override fun onBindViewHolder(holder: FavouriteDataAdapter.ItemViewHolder, position: Int) {
